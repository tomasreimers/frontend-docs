...
# The ecosystem: more tools, more problems
...
If you find this all dizzying, I have good and bad news for you: none of this is specific to JavaScript. CSS has gone through the same transformation in recent years. With [LESS](https://lesscss.org/) and [SASS](https://sass-lang.com/) emerging as alternative syntaxes. And more recently SASS adopting [modules](https://github.com/css-modules/css-modules) to help developers better organize their code. 

With SASS modules and a packager (like webpack), I can now author a react component that imports a style and references any defined classnames like variables.
