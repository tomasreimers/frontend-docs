...
import FixedFluid from "../public/images/content/design-systems/fixed-fluid.png"
...
import Grid from "../public/images/content/design-systems/grid.webp"
...
<Image src={FixedFluid} alt="Fixed vs fluid layouts" />
...
<Image src={Grid} alt="Grid layout" />
...
In CSS, themes are typically implemented with CSS variables (having variables background and text colors).
