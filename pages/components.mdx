...
<Example template="react" visibleFiles={["/index.js", "/public/index.html"]} files={{
...
JSX enabled this syntax by adding a build step to [transpile](https://legacy.reactjs.org/docs/introducing-jsx.html) the HTML-like syntax into functions. 
...
<Example template="react" files={{
  "/index.js": `import React, { useRef, useEffect } from "react";
import { createRoot } from "react-dom/client";
