...
The server will recieve the URL, verb, headers, and body and respond with: 
...
While CSRF protects unauthorized user requests, an old attack was to embed people's sites in iframes. [Iframes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe) allow you to embed other websites, and while useful for sharding our your site, they can also be used maliciously.
