...
You can open that HTML file to see it with the style applied. And, [like our HTML example](/html/#try-it-yourself), we can continue to experiment using JSFiddle:
